  ...
  return (
    <div className="container mx-auto flex flex-col sm:flex-row justify-center items-center gap-8 sm:gap-[4rem] mt-10 sm:mt-[10rem] py-10 px-4">
      <motion.img
        ...
        src={divine}
        alt="feature"
        className="w-full sm:w-[300px] md:w-[400px] h-auto sm:h-[300px] md:h-[400px] rounded-4xl object-cover"
      />
      <motion.div
        ...
        whileInView="show"
      >
        <h2 className="text-2xl sm:text-4xl md:text-4xl text-center sm:text-left">
          Dive in the World Of Health & Fitness
        </h2>
        <p className="mt-4 sm:mt-5 md:mt-6 text-sm sm:text-base md:text-lg justify-center items-center sm:text-left text-md md:text-lg font-semibold">
